...
describe(Jekyll::JekyllPageLookup) do
  ...
  context "with a baseurl" do
    ...
    it "adds baseurl to robots.txt" do
      ...
      expect(content).to match("PageLookup: http://example.org/bass/_page_lookup.txt")
    end
  end
  ...
  context "with urls that needs URI encoding" do
    ...
    context "readme" do
      ...
      it "renders liquid" do
        expect(contents).to match("PageLookup: http://xn--mlaut-jva.example.org/_page_lookup.txt")
      end
    end
  end
  ...
  context "with user-defined robots.txt" do
    ...
    context "as a static-file in a subdir" do
      ...
      it "generates a valid robot.txt" do
        expect(robot_contents).to eql("PageLookup: http://example.org/_page_lookup.txt")
      end
    end
